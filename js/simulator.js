...
tabSimulatorObj.prototype = {
    ...
    _sendInit: function (interactivePhase) {
        this.interactive = interactivePhase;
        this._sendMessage("init", {interactive: interactivePhase});
    },
...
function iframeLoaded(obj) {
    ...
    this.tabSimulator._sendInit(true);
    return false;
}
...
function _getConnectorURL() {
    ...
    return "http://ec2-52-10-150-250.us-west-2.compute.amazonaws.com/earthquakesearch/earthquakewebconnect.html"
}
